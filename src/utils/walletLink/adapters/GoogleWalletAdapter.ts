...
import type WalletLinkAdapter from "../WalletLinkAdapter";

export class GoogleWalletAdapter implements WalletLinkAdapter {

  public getWalletLink({ ticket_token, ticketHolderName, id }: {
    ticket_token: string,
